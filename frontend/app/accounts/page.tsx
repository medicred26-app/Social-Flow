...
import { deleteAccount, fetchAccounts } from '@/lib/data/api';
...
export default function AccountsPage() {
  ...
  const connect = (platform: SocialPlatform) => {
    if (!configured[platform]) {
      setNotification({
        type: 'error',
        message: `${PLATFORM_CONFIGS[platform].displayName} is not configured. Add its app credentials in frontend/.env.local.`,
      });
      return;
    }
